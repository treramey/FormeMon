    ...
    <section id="pricing">
      <Container>
        ...
        <p className="mb-14 max-w-3xl text-center w-full">
          Choose the plan that suits you best. Enjoy full access to premium content and expert
          support. <br className="hidden md:block" /> Start your journey today and achieve your
          goals!
        </p>
