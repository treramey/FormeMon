  ...
  return (
    <section id="features" className="container mx-auto py-24 bg-gray-100 dark:bg-background">
      ...
      <p className="text-center text-2xl max-w-2xl mx-auto mb-12">
        This code starter kit includes the frameworks, libraries, and tech I use most and believe in
        to be a great choice in regards to performance, ease of development, and customizability.
      </p>
