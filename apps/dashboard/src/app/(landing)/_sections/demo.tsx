    ...
    <section className="bg-green-900 py-24">
      <div className="container mx-auto text-center">
        ...
        <h3 className="text-2xl mb-8 max-w-2xl mx-auto">
          Don&apos;t worry, I have experience making over 600 tutorial videos on youtube and this
          starter kit includes documentation and video walkthroughs. I&apos;ll teach you how to:
        </h3>
