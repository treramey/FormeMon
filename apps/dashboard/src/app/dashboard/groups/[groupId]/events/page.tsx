  ...
  return (
    <>
      <div className="space-y-8">
        <h2 className={cn(pageTitleStyles, "flex justify-between items-center")}>
          Events
          {isGroupOwner && <CreateEventButton />}
        </h2>

        {events.length === 0 && (
          <div className={cn(cardStyles, "flex flex-col gap-8 justify-center items-center p-12")}>
            <Image
        ...
        {events.length > 0 && (
          <div className="space-y-24">
            <div className="space-y-8">
              <h3 className={cn(pageTitleStyles, "text-2xl flex justify-between items-center")}>
