...
export default async function Settings({
  ...
  return (
    <div className="space-y-8">
      <h1 className={`${pageTitleStyles} text-center md:text-left`}>Group Settings</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <ConfigurationPanel title={"Group Visibility"}>
          <div className="flex flex-col gap-8">
            <p className="dark:text-gray-400 text-sm">
              Groups are private by default. If you want random people on the internet to find and
              join your group without an invite, switch this to on.
            </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <ConfigurationPanel title={"Group Description"}>
          <GroupDescriptionForm groupId={group.id} description={group?.description ?? ""} />
        </ConfigurationPanel>
