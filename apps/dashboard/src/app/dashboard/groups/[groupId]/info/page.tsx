...
import { getPublicGroupInfoByIdUseCase, isAdminOrOwnerOfGroupUseCase } from "@/use-cases/groups";
...
export default async function InfoPage({
  ...
  const isAdminOrOwner = await isAdminOrOwnerOfGroupUseCase(user, parseInt(groupId));
