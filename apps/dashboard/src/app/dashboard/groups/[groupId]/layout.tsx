...
import { isGroupOwnerUseCase, isGroupVisibleToUserUseCase } from "@/use-cases/membership";
...
export default async function GroupLayout({
  ...
  const isGroupVisibleToUser = await isGroupVisibleToUserUseCase(user, group.id);
