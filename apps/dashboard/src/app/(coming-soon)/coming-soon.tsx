          ...
          <div className="grid max-w-screen-xl px-4 pt-12 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-24 lg:grid-cols-12 lg:pt-16">
            <div className="mr-auto place-self-center col-span-7">
              <h1 className="font-semibold max-w-2xl mb-6 text-4xl leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
                🚀 I&apos;m working on the <span className="italic text-red-400">perfect</span> SaaS
                starter kit.
              </h1>

              <h2 className="text-2xl mb-8 font-light">
                This Next.js starter kit will enable you to setup your own SaaS product with monthly
                subscriptions, including a complete walkthrough on how to set it all up and maintain
                it.
              </h2>
      ...
      <section className="border-slate-400 border-t border-b dark:border-slate-500 relative py-12 dark:bg-gray-950 shadow-sm bg-repeat bg-paper dark:bg-plus">
        <div className="container mx-auto max-w-4xl pt-12 dark:text-gray-200">
          ...
          <p className="mb-6 text-xl leading-10">
            For those who watch my channel, you know I work on lot of different side projects.
            I&apos;ve even lost track how many times I&apos;ve reinstalled the same ShadCN
            components. To speed up my personal time to launch new products, I&apos;m building a
            complete starter kit which includes most of everything you&apos;d need when creating a
          ...
          <p className="mb-6 text-xl leading-10">
            Additionally, I&apos;m working on a complete walkthrough on how to setup the project
            including any third party services, hosting, and how to run migrations and add new
            features, etc.
          </p>

          <p className="text-xl leading-10 text-center mt-24 mb-24">
            I don&apos;t want to sell you code. I want to <strong>teach you</strong> how to build,
            launch, and iterate on your product. I&apos;m excited to help you build!
          </p>
        </div>
      </section>
    </>
