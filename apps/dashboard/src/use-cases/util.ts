...
export function createUseCase<
  ...
  OutputValidation extends ZodTypeAny,
  InputValidation extends ZodTypeAny,
>(options: ValidatedCallbackOptions<CallbackInput, OutputValidation, InputValidation>) {
  return async function (input: CallbackInput): Promise<z.infer<OutputValidation>> {
